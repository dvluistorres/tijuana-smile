...
const Header = () => (
  <div className="app__header app__wrapper section__padding" id="HEADER">
    <div className="app__wrapper_info">
      ...
      <p className="app__header-p p__opensans" style={{ margin: '2rem 0', color:'black'}}>Our team of friendly doctors provide all the dental services you may need, including specialist treatment.</p>
